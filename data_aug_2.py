...
if __name__ == "__main__":
    ...
    outputfolder_image = "./data/output/images/"
    outputfolder_label = "./data/output/labels/"
    # dataPath = "./data/train/"
    # dataPath = "E:\\python code\\data_aug_2\\data\\class_4_dataset\\snake-RGB\\t-1\\"
    dataPath = "./data/coco-t-1/"
    backgroundFilePath = "./data/bkimg/"
    bkgFileLoader = BackgroundFileLoader()
    bkgFileLoader.loadbkgFiles(backgroundFilePath)
    
    os.makedirs(outputfolder, exist_ok=True)
    os.makedirs(outputfolder_image, exist_ok=True)
    os.makedirs(outputfolder_label, exist_ok=True)
    ...
    for sampleImgPath in image_files:
        ...
        while count < OUTPUT_PER_SAMPLE:
            ...
            cv.imwrite(outputfolder_image + finalImgName + ".jpg", finalImg)
            cv.imwrite(outputfolder + finalROIImgName + ".jpg", finalDrawROIimg)    
            with open(outputfolder_label + finalImgName + ".txt", "w") as f:
