...
if __name__ == "__main__":
    ...
    for sampleImgPath in image_files:
        ...
        image_modifier = SampleImgTransformer(
            image=org_Img, bg_color=BACKGROUND_COLOR, bg_thresh=BACKGROUND_THRESH, bboxes = bounding_boxes, classes = class_nums
        )
        ...
        while count < OUTPUT_PER_SAMPLE:
            ...
            # image_modifier.addMedianNoise(percentPixel = 0.5, percentSalt = 0.5)
